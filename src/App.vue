        ...
        <ul class="list-group" v-if="userInfo.hasOwnProperty('access')">
          ...
          <li class="list-group-item" v-if="userInfo.access.student.show===1">
            ...
            <div class="list-group">
              ...
              <router-link to="/archives/student_seas" class="list-group-item" v-if="userInfo.access.student.child[1]===1"
            >学生公海
            </router-link>
              <router-link to="/archives/student_statistics" class="list-group-item" v-if="userInfo.access.student.child[2]===1"
              >统计分析
              </router-link>
            </div>
          </li>
