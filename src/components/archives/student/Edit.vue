              ...
              <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                  ...
                  <div class="panel-body">
                    <table class="table">
                      ...
                      <tr v-for="(item, i) in tab1.doc" :key="i">
                        ...
                        <td>
                          <router-link :to="{path:'/functions/answer/addAnswer',query:{id:item.id}}" class="cded">
                            {{item.title}}
                          </router-link>
                        </td>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading clearfix">
                    ...
                    <span class="pull-right">
                                             <router-link
                                               :to="{path:'/functions/initApply/ChooseSchool', query:{sid:id,source:1}}">
                                                 <span class="iconfont c999">&#xe73e;</span>
                                             </router-link>
                                         </span>
                  </div>
                  <div class="panel-body">
                    ...
                    <div class="panel-noData" v-if="tab1.apply_process.length===0">
                      ...
                      <router-link :to="{path:'/functions/initApply/ChooseSchool', query:{sid:id,source:1}}" class="cded">点击前往创建
                      </router-link>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body" style="height:131px;overflow:hidden;">
                        ...
                        <p style="word-break:break-all; word-wrap:break-word;">
                          登录地址：{{'http://student.applyera.com/?cid='+tab1.login_info.c_id}}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <tr>
                <th>
                  <label for="EnclosureAll" class="mr-10">
                    <input type="checkbox" name="EnclosureAll" id="EnclosureAll" value="sAll"
              ...
              <tr>
                <th>
                  <label for="EnclosureAll2" class="mr-10">
                    <input type="checkbox" name="EnclosureAll" id="EnclosureAll2" value="cAll"
                           style="vertical-align:top;"/>
                  </label>
                  <img src="../../../../static/images/007.png" alt="" width="20" class="div_vm">
                      ...
                      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="row">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                              <label>语言成绩</label>
                              <select name="lang_score_type" class="form-control selectpicker show-tick"
                      ...
                      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="row">
                          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                              <label>学术成绩</label>
                              <select name="acad_score_type" class="form-control selectpicker show-tick"
