            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-inline text-right">
                    <div class="form-group ml-10">
                        <router-link :to="{path:'/setting/ability/editability', query:{id: list.id}}" class="btn btn-default"><i class="iconfont">&#xe60f;</i> 编辑</router-link>
                    </div>
                    <div class="form-group ml-10">
        ...
        <div class="clearfix" v-if="Object.keys(list).length > 0">
            <form class="form-horizontal">
                <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 lh34">{{list.title}} </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11 pt-5 lh20">{{list.content}}</div>
                </div>
            </form>
        </div>
