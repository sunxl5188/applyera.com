                            ...
                            <div class="col-sm-11" style="width: 88.8%;">
                                <div class="custom-radio-box">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="yht_status" class="custom-control-input"
                                               id="yht_status1" :value=1 v-model="info.yht_status"
                                               :checked="info.yht_status===1">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline ml-15">
                                        <input type="radio" name="yht_status" class="custom-control-input"
                                               id="yht_status2" :value=0 v-model="info.yht_status"
                                               :checked="info.yht_status===0">
                ...
                <div class="row" v-show="info.yht_status===1">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select name="yht_id" v-model="info.yht_id" class="form-control selectpicker show-tick"
                                        data-size="10" data-width="fit" data-live-search="true">
                                    <option value="">请选择该产品需要签署的合同</option>
                                    <option :value="item.yht_id" v-for="(item, i) in info.yht_list" :key="i">
                                        {{item.yht_name}}
                                    </option>
                                </select>
                            </div>
