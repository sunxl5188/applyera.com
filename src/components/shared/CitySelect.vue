<template>
    <div class="form-inline" style="display:inline-block;">
        <!--省市区三级联动菜单-->
        <select :name="pName" class="form-control selectpicker show-tick" data-size="10" data-container="body" data-live-search="true" data-dropup-auto="false"
        ...
        <select :name="cName" class="form-control selectpicker show-tick" data-size="10" data-container="body" data-dropup-auto="false"
        ...
        <select :name="aName" class="form-control selectpicker show-tick" data-size="10" data-container="body" data-dropup-auto="false"
