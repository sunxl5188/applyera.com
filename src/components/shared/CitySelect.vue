<template>
    <div class="form-inline">
        ...
        <select :name="cName" class="form-control selectpicker show-tick" data-dropup-auto="false"
        ...
        <select :name="aName" class="form-control selectpicker show-tick" data-dropup-auto="false"
