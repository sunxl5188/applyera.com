                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li v-for="(item,i) in sign_status" :key="i">
                              <a href="#" v-if="item.status_name === modalData.student_info.sign_status_str">{{item.status_name}}
                                <span class="glyphicon glyphicon-ok pull-right c999 ml-10"></span></a>
                              <a href="#"
                                 @click="modalData.student_info.sign_status_str = item.status_name;setStudentState(modalData.student_info.stu_id, item.id)"
                                 v-if="item.status_name !== modalData.student_info.sign_status_str">{{item.status_name}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                          ...
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li v-for="(item,i) in studentTypeArr" :key="i">
                                <a href="#" v-if="item.stu_type === modalData.student_info.student_type_str">{{item.stu_type}}<span
                                    class="glyphicon glyphicon-ok pull-right c999 ml-10"></span></a>
                                <a href="#"
                                   @click="modalData.student_info.student_type_str=item.stu_type;setStudentType(modalData.student_info.stu_id, item.id)"
                                   v-if="item.stu_type !== modalData.student_info.student_type_str">{{item.stu_type}}</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-8">
                          <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" type="button"
                                    data-toggle="dropdown">
                              <img
                                  :src="modalData.student_info.adviser_img || 'https://via.placeholder.com/20x20/FF5733/ffffff'"
                                  class="img-circle" width="30" height="30"/>
                            </button>
                            <ul class="dropdown-menu">
                              <li v-for="(item, i) in adviserArr" :key="i">
                                <a href="#"
                                   v-if="item.head_img === modalData.student_info.adviser_img">{{item.name}}<span
                                    class="glyphicon glyphicon-ok pull-right c999 ml-10"></span></a>
                                <a href="#"
                                   ...
                                   v-if="item.head_img !== modalData.student_info.adviser_img">{{item.name}}</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="followItem" v-for="(item,i) in modalData.follow_info" :key="i">
                    <div class="clearfix font12 followTitle">
                                        <span class="pull-left">
                                            <img
                                                :src="item.head_img || 'https://via.placeholder.com/20x20/FF5733/ffffff'"
                  ...
                  <div class="form-group">
                    <div class="col-sm-9">
                      ...
                      <div class="dropdown" style="display: inline-block;margin-right: 0;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                          <li @click="setRepeat(item.val, 1)" :class="repeat===item.val?'po_re active':'po_re'"
                      ...
                      <div class="dropdown" style="display: inline-block;margin-right: 0;">
                        <i :class="remind!==0?'iconfont font20 cded':'iconfont font20 c999'"
                           ...
                           data-toggle="dropdown">&#xe6b4;</i>
                        <ul class="dropdown-menu dropdown-menu-right">
                          <li @click="setRepeat(item.val, 2)" :class="remind===item.val?'active':''" v-for="(item, i) in remindArr" :key="i">
                            <a href="javascript:void(0);">{{item.title}}</a>
                          </li>
                        </ul>
                      </div>
