<template>
    <div>
        ...
        <div v-if="!loading">
            <form id="ExamForm" class="form-horizontal" @submit.prevent="validateBeforeSubmit" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="pt-15" v-if="exam.is_academic_score">
                                <div v-for="(itemObj, key) in examArr" :key="key">
                                    ...
                                    <div v-if="key==='gre_subject'">
                                        <!--GRE Subject-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'gresb'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label><a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='gmat'">
                                        <!--GMAT-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'gmat'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label><a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='sat'">
                                        <!--SAT-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'sat'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='sat_subject'">
                                        <!--SAT Subject-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'satsb'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='college_enter_exam'">
                                        <!--高考-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'gk'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='act'">
                                        <!--ACT-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'act'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='a_level'">
                                        <!--A-Level-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'al'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='o_level'">
                                        <!--O-Level-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'ol'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='gcse'">
                                        <!--GCSE-->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'gcse'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='btec'">
                                        <!--BTEC--->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'btse'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
                                    ...
                                    <div v-if="key==='ib'">
                                        <!--IB--->
                                        <div class="clearfix elementList" v-for="(item, i) in itemObj" :key="'ib'+i">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
                                                        <label>考试类别</label> <a href="javascript:void(0);" class="cded ml-15"
