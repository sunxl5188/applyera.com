            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="second_guardian_nationality" class="form-control selectpicker" data-live-search="true" data-size="10"
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <select name="second_guardian_alive" class="form-control selectpicker"
                                        v-model.number="family.second_guardian_alive" @change="showTime();RefreshSelect()">
