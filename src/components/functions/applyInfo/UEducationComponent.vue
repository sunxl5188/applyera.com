                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" :name="'activity[name]['+i+']'" class="form-control"
                                   placeholder="请输入活动名称" v-validate="'required|alpha_dash'" data-vv-as="活动名称"
                                   v-model="item.name">
                            <div class="validateTip" v-show="errors.has('activity[name]['+i+']')">
                                {{ errors.first("activity[name]["+i+"]") }}
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" :name="'activity[position]['+i+']'" class="form-control"
                                   placeholder="请输入英文担任职务" v-validate="'required|alpha_dash'" data-vv-as="担任职务"
                                   v-model="item.position">
                            <div class="validateTip" v-show="errors.has('activity[position]['+i+']')">
                                {{ errors.first("activity[position]["+i+"]") }}
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" :name="'activity[time]['+i+']'" :data-name="'activity|time|'+i"
                                   class="form-control times"
                                   placeholder="请输入活动时间" v-validate="'required|date_format:yyyy-MM-dd'"
                                   data-vv-as="活动时间" v-model="item.time">
                            <div class="validateTip" v-show="errors.has('activity[time]['+i+']')">
                                {{ errors.first("activity[time]["+i+"]") }}
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea :name="'activity[detail]['+i+']'" class="form-control"
                                      placeholder="请用英文和数字填写活动说明与取得成就" v-validate="'required|ens'"
                                      data-vv-as="活动说明" v-model="item.detail"></textarea>
                            <div class="validateTip" v-show="errors.has('activity[detail]['+i+']')">
                                {{ errors.first("activity[detail]["+i+"]") }}
                            </div>
                        </div>
                    </div>
                </div>
